    ...
    <div className="flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 justify-center">
        {repos.Repos.map((repo: Repos) => (
          <div key={repo.name} className="bg-gradient-to-b from-slate-200 to-gray-200 dark:from-slate-700 from-10% dark:to-gray-700 border-2 shadow-md shadow-gray-500 border-slate-500 rounded-lg px-3 pt-2 pb-4 h-48 w-40 flex flex-col justify-between">
